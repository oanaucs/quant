...
# The URLs where the fashion MNIST data can be downloaded.
...
def _extract_images(filename, num_images):
  ...
  Args:
    filename: The path to an fashion MNIST images file.
...
def _get_output_filename(dataset_dir, split_name):
  ...
  """
  return '%s/fashion_mnist_%s.tfrecord' % (dataset_dir, split_name)
...
def run(dataset_dir):
  ...
  print('\nFinished converting the fashion MNIST dataset!')
